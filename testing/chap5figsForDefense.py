...
if first:
    ...
    pyplot.scatter(0,0,s=150,c='k',edgecolor='g',zorder=2,lw=2,label='Start Point') # start state

    #rev end point
    endTh = -np.pi/4-.22
    pyplot.scatter(sReal[1][2]*np.cos(endTh)+sReal[1][0],\
                   sReal[1][2]*np.sin(endTh)+sReal[1][1],\
                   s=150,c='k',edgecolor='r',zorder=2,lw=2,label='End Point')

    pyplot.scatter(0.1125,0.02,s=150,c='k',edgecolor='m',zorder=2,lw=2,label='Observation') # observation
    ...
    pyplot.scatter(0.12*np.cos(aTh),0.0,\
                   s=150,c='k',edgecolor='r',zorder=2,lw=2)
...
if fourth2:
    ...
    numPoints = len(positions[0])
    print numPoints
    probs = [1.5*1.0/numPoints]*numPoints
    ...
    pyplot.xlabel(r'$\theta_1$ [m]')
    pyplot.ylabel(r'$\theta_2$ [m]')
    pyplot.savefig("/mit/barragan/Public/LIS/defenseFigures/"+dirString+"dim0"+sString+".pdf",bbox_inches='tight')
    pyplot.show()
    ...
    # plot thin histogram
    b = [np.arange(-1,1.5,.5),np.linspace(-.02,0.02,2)]
    ...
    if plotObs:
        highR = [-np.sqrt(r**2-o[1]**2)+o[0],np.sqrt(r**2-o[1]**2)+o[0]]
        pyplot.plot(highR,[0.0,0.0],lw=14,c=cC)
    ...
    #pyplot.colorbar()
    pyplot.xlabel(r'$\theta_3$ [m]')
    pyplot.savefig("/mit/barragan/Public/LIS/defenseFigures/"+dirString+"dim1"+sString+".pdf",bbox_inches='tight')
    pyplot.show()
    ...
    pyplot.xlabel('x [m]')
    pyplot.ylabel('y [m]')
    pyplot.savefig("/mit/barragan/Public/LIS/defenseFigures/"+dirString+"dim2"+sString+".pdf",bbox_inches='tight')
    pyplot.show()
    ...
    H,xedges,yedges = np.histogram2d(xP,yP,\
                                     bins=b,weights=probsP)
    print 'pris max',max(H[0])
    pyplot.imshow(H.T,interpolation='None',
                  extent=[xedges[0],\
                          xedges[-1],\
                          yedges[0],\
                          yedges[-1]],\
                  vmin=0,vmax=valMax,origin='lower',cmap=cm,norm=cNorm,zorder=1)
    #pyplot.colorbar()
    ...
    pyplot.xlabel('x [m]')
    pyplot.ylabel('y [m]')
    pyplot.savefig("/mit/barragan/Public/LIS/defenseFigures/"+dirString+"dim3"+sString+".pdf",bbox_inches='tight')
    pyplot.show()
...
if fifth:
    ...
    pyplot.xlabel(r'$\theta_1$ [m]')
    pyplot.ylabel(r'$\theta_2$ [m]')
    #pyplot.savefig("/mit/barragan/Public/LIS/defenseFigures/proj0"+sString+".pdf",bbox_inches='tight')
    pyplot.show()
    ...
    pyplot.xlabel(r'$\theta_1$ [m]')
    pyplot.ylabel(r'$\theta_2$ [m]')
    #pyplot.savefig("/mit/barragan/Public/LIS/defenseFigures/proj1"+sString+".pdf",bbox_inches='tight')
    pyplot.show()
    ...
    pyplot.xlabel('x [m]')
    pyplot.ylabel('y [m]')
    #pyplot.savefig("/mit/barragan/Public/LIS/defenseFigures/proj2"+sString+".pdf",bbox_inches='tight')
    pyplot.show()
    ...
    pyplot.xlabel('x [m]')
    pyplot.ylabel('y [m]')
    #pyplot.savefig("/mit/barragan/Public/LIS/defenseFigures/proj3"+sString+".pdf",bbox_inches='tight')
    pyplot.show()
