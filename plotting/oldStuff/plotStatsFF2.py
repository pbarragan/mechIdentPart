...
if(False):
    ...
    files = files[:160] # only take the first 160 for this
        ...
        for j in range(numMT):
            for k in range(numT):
                ...
                if e<1000:
                    ...
                    print "This was a huge ERROR!"
                print rStatesSave[sInd]
                print mStatesSave[sInd]
                print auxUtils.stateDist2(rStatesSave[sInd],mStatesSave[sInd])
